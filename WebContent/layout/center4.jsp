                        ...
                        load: function() {                                              
                            ...
                            setInterval(function() {                                    
                              $.getJSON("http://localhost:8080/WSN/highcharts.action",{ip:'<%=ips%>'}, function (data) {
                            	  ...
                            	  //更新当前光照强度
                            	  $('#light_chart_display').empty();
                            	  $('#light_chart_display').append("<br/><span style='color:blue;font-size: 20px'>当前节点光照"+y+"LUX</span>");
                              });
...
/* 		           subtitle: {
   ...
   <div id='light_chart_display' data-options="region:'center',border:true" style="text-align:center;width:50px">
   </div>
   </div> 